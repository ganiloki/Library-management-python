...
class menu:
    ...
    def __init__(self):
        ...
        l1=Button(self.a,text='BOOK DATA',font='Papyrus 22 bold',fg='black',bg='white',width=19,padx=10,borderwidth=0,command=self.book).place(x=100,y=500)
        l2=Button(self.a,text='STUDENT DATA',font='Papyrus 22 bold',fg='black',bg='white',width=19,padx=10,borderwidth=0,command=self.student).place(x=800,y=500)
        self.root.mainloop()
    ...
    def book(self):
        ...
        l4=Button(self.a,text='All Books',font='Papyrus 22 bold',fg='black',bg='white',width=15,padx=10,command=self.all).place(x=12,y=300)
        l4=Button(self.a,text='Main Menu',font='Papyrus 22 bold',fg='black',bg='white',width=15,padx=10,command=self.mainmenu).place(x=12,y=500)
    ...
    def student(self):
        ...
        l3=Button(self.a,text='Student Activity',font='Papyrus 22 bold',fg='black',bg='white',width=15,padx=10,command=self.activity).place(x=12,y=300)
        l4=Button(self.a,text=' Main Menu ',font='Papyrus 22 bold',fg='black',bg='white',width=15,padx=10,command=self.mainmenu).place(x=12,y=600)
...
def Database():
    ...
    if cursor.fetchone() is None:
        cursor.execute("INSERT INTO `login` (username, password) VALUES('Ganesh', '1234')")
        conn.commit()
